...
% environment per impostare il codice in piu' pagine (vobx \bgroup \egroup serve ad evutare che venga diviso da page breaks)
\newenvironment{code}{\captionsetup{type=listing}\vbox\bgroup}{\egroup\hfill\break}

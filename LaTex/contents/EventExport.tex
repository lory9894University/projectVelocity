...
\end{code}
Come mostrato nel codice d'esempio \ref{lst:RepositoryPattern}, il \textit{Repository Pattern} viene implementato tramite \textit{Hibernate} e \textit{JPA}.
...
La richiesta viene effettuata da un \textit{HTTP client} che, se il documento è stato caricato corretamente, restituisce il path del documento creato.

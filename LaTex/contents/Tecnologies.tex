...
%TODO: modificare l'mmagine con gimp ed eliminare la tumbliing Count window
...
\todo{c'è anche il discorso del partitioning dei dati, quando ne scrivo la sezione aggiungo qui}
\\\\
